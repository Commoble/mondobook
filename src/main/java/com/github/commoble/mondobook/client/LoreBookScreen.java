...
public class LoreBookScreen extends Screen
{
	...
	private static final int TEXT_START = 36;
	private static final int TEXT_END = 150;
	private static final int TEXT_WIDTH = TEXT_END - TEXT_START;
	private static final int BOOK_TEXTURE_START = 26;
	private static final int BOOK_TEXTURE_END = 166;
	private static final int BOOK_TEXTURE_WIDTH = BOOK_TEXTURE_END - BOOK_TEXTURE_START;
	private static final int PAGE_NUMBER_END = 148;
	private static final float PAGE_NUMBER_Y_START = 18F;
	private static final int LEFT_PAGE_OFFSET = BOOK_TEXTURE_WIDTH;
	private static final int RIGHTWARD_SHIFT = LEFT_PAGE_OFFSET/2;
	private static final int MAX_LINES_ON_PAGE = 14;
	private static final int PAGE_TEXT_START = 32;
	private static final int LINE_HEIGHT = 9;
	private static final int TEXT_OFFSET_FROM_BOOK_CENTER = 10;
